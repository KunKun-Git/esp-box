...
static const sr_cmd_t g_default_cmd_info[] = {
    ...
    {SR_CMD_FINISH, SR_LANG_EN, 0, "Sing a song", "Sgl c Sel", {NULL}},
    {SR_CMD_FINISH, SR_LANG_EN, 0, "Play Music", "PLd MYoZgK", {NULL}},
    {SR_CMD_SINGLE, SR_LANG_EN, 0, "Next Song", "NfKST Sel", {NULL}},
    {SR_CMD_HYBRID, SR_LANG_EN, 0, "Pause Playing", "PeZ PLdgl", {NULL}},
    ...
    {SR_CMD_FINISH, SR_LANG_CN, 0, "已完成", "yi wan cheng", {NULL}},
    {SR_CMD_SINGLE, SR_LANG_CN, 0, "单采", "dan cai", {NULL}},
    {SR_CMD_HYBRID, SR_LANG_CN, 0, "混采", "hun cai", {NULL}},
